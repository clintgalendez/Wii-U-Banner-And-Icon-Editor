        ...
        <nav className="w-full bg-gray-50 shadow-sm rounded-lg mx-auto max-w-7xl mt-4 mb-8">
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0">
                        <div className="flex items-center justify-center sm:w-14 sm:h-14 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105">
                            <img src="src/assets/cog_logo.png" alt="C.O.G. Logo" />
                        </div>
                    </div>
                </div>
            </div>
